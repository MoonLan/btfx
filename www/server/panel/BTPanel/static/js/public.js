...
function getFlieSpeed (sele,wsStr,mod_name,rdata,fun) {
  if (!$(sele).length) return;
    body = '<p class="bt-progress-search"><span>文件搜索中<span><img src="/static/img/ing.gif"></p>\
		<div class="bt-progress"><div class="bt-progress-bar" style="width:0%"><div class="bt-progress-text">0%</div></div></div>\
		<p class="f12 c9"><span class="pull-left bt-progress-used">0</span>'+ '/'+'<span class="bt-progress-total">0</span></p>';
    $(sele).prev().hide();
    $(sele).css({ "margin-left": "-37px", "width": "380px" });
    $(sele).parents(".layui-layer").css({ "margin-left": "-100px" });
    $(sele).html(body);
        ...
        },
        {
          type: 'group', align: 'right', width: 95, title: lan.files.recycle_bin_th5, group: [{
            ...
            event: function (row, index, ev, key, _that) {
              that.ReRecycleBin(row.rname, function (rdata) {
                if(rdata.status){
